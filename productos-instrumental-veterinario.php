        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-xs-12 col-sm-6">
                    <h1> Jeringas Ecomix </h1>
                </div>
                <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                    <div class="sub_title_section">
                        <ul class="sub_title">
                            <li> <a href="#"> Home </a> <i class="fa fa-angle-right" aria-hidden="true"></i> </li>
                            <li> Jeringas Ecomix </li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="sidebar_widget">
                                    <div class="sc_shop_add sc_shop_fullwidth">
                                        <a href="#"><img src="images/shop/banner_veterinaria.jpg" class="img-responsive" alt="shop_img" /></a>
                                    </div>
                                </div>
                                <div class="sidebar_widget">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        ...
                                                        <img src="images/shop/ecomix-dial.jpg" alt="shop_img" class="img-responsive" />
                                                    ...
                                                    <div class="btc_shop_indx_img_cont_wrapper">
                                                        ...
                                                        <h1><a href="ecomix-dial.php">ECOMIX PLASTICA DIAL 50cc.</a></h1>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        ...
                                                        <img src="images/shop/ecomix-20.jpg" alt="shop_img" class="img-responsive" />
                                                        <div class="cc_li_img_overlay">
                                                            <div class="cc_li_img_text">
                                                                <ul>
                                                    ...
                                                    <div class="btc_shop_indx_img_cont_wrapper">
                                                        ...
                                                        <h1><a href="ecomix-20.php">ECOMIX MATIC AUTODOSIFICADORA 20cc.</a></h1>
                                                        <div class="cc_li_cont_wrapper">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        ...
                                                        <img src="images/shop/ecomix-10.jpg" alt="shop_img" class="img-responsive" />
                                                        <div class="cc_li_img_overlay">
                                                            <div class="cc_li_img_text">
                                                                <ul>
                                                                    <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                                                    ...
                                                    <div class="btc_shop_indx_img_cont_wrapper">
                                                        ...
                                                        <h1><a href="ecomix-10.php">ECOMIX MATIC AUTODOSIFICADORA 10cc.</a></h1>
