        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-xs-12 col-sm-6">
                    <h1> Manga para Ovinos </h1>
                </div>
                <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                    <div class="sub_title_section">
                        <ul class="sub_title">
                            <li> <a href="#"> Home </a> <i class="fa fa-angle-right" aria-hidden="true"></i> </li>
                            <li> Manga para Ovinos </li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="video_img_section_wrapper">
						<div class="video_nav_img hidden-xs">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <a class="button secondary url owl_nav" href="#zero"><img src="images/shop/manga-ovinos.jpg" class="img-responsive" alt="nav_img"></a>
                            </div>
                        ...
                        <div class="cc_ps_top_slider_section">
                            <div class="owl-carousel owl-theme">
                                <div class="item" data-hash="zero">
                                    ...
                                    <img class="small img-responsive" src="images/shop/manga-ovinos.jpg" alt="small_img" />
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="btc_shop_single_prod_right_section">
                        ...
                        <div class="btc_shop_sin_pro_icon_wrapper">
                            ...
                            <h5>Manga de trabajo fija. Permite configuraciones de 3, 6 o 9 mts. Puerta de aparte de 2 vías opcional.</h5>
