...
<head>
    ...
    <title> Electrificadores Inteligentes </title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-xs-12 col-sm-6">
                    <h1> Electrificadores Inteligentes </h1>
                </div>
                <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                    <div class="sub_title_section">
                        <ul class="sub_title">
                            <li> <a href="#"> Home </a> <i class="fa fa-angle-right" aria-hidden="true"></i> </li>
                            <li> Electrificadores Inteligentes </li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="video_img_section_wrapper">
						<div class="video_nav_img hidden-xs">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <a class="button secondary url owl_nav" href="#zero"><img src="images/shop/pastor-inteligente.jpg" class="img-responsive" alt="nav_img"></a>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cc_ps_tabs">
                                <a class="button secondary url owl_nav" href="#one"><img src="images/shop/pastor-inteligente-px75i.jpg" class="img-responsive" alt="nav_img"></a>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cc_ps_tabs">
                                <a class="button secondary url owl_nav" href="#two"><img src="images/shop/pastor-app.jpg" class="img-responsive" alt="nav_img"></a>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cc_ps_tabs">
                                <a class="button secondary url owl_nav" href="#three"><img src="images/shop/tabla-pastor-inteligente.jpg" class="img-responsive" alt="nav_img"></a>
                            </div>
						</div>
                        <div class="cc_ps_top_slider_section">
                            <div class="owl-carousel owl-theme">
                                <div class="item" data-hash="zero">
                                    ...
                                    <img class="small img-responsive" src="images/shop/pastor-inteligente.jpg" alt="small_img" />

                                </div>
                                <div class="item" data-hash="one">

                                    <img class="small img-responsive" src="images/shop/pastor-inteligente-px75i.jpg" alt="small_img" />

                                </div>
                                <div class="item" data-hash="two">

                                    <img class="small img-responsive" src="images/shop/pastor-app.jpg" alt="small_img" />
                                </div>
                                <div class="item" data-hash="three">
                                    <img class="small img-responsive" src="images/shop/tabla-pastor-inteligente.jpg" alt="small_img" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="btc_shop_single_prod_right_section">
                        <h1>Electrificadores Inteligenestes </h1>
                        <div class="btc_shop_sin_pro_icon_wrapper">
                            ...
                            <h5>El futuro del electrificador con el nuevo sistema de telemetría que permite de manera remota tener una medición de diferentes parámetros. Conociendo así el funcionamiento del sistema pastoril en todo momento evitando así que los animales salgan de los perímetros estipulados en el plan de pastoreo. A su vez facilita la reparación de los alambrados gracias al control de encendido y apagado a distancia del equipo, optimizando los recursos tanto humanos como económicos.</h5>
                            <ul>
                            <h5>FUNCIONES / PARÁMETROS</h5>
                                <li><i class="fa fa-long-arrow-right"></i> Tensión en la cerca</li>
                                <li><i class="fa fa-long-arrow-right"></i> Estado de la batería</li>
                                <li><i class="fa fa-long-arrow-right"></i> Estado del equipo</li>
                                <li><i class="fa fa-long-arrow-right"></i> Geolocalización</li>
                                <li><i class="fa fa-long-arrow-right"></i> Encendido remoto</li>
                            </ul>
                        </div>
