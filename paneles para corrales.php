                    ...
                    <div class="video_img_section_wrapper">
						<div class="video_nav_img hidden-xs">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <a class="button secondary url owl_nav" href="#zero"><img src="images/shop/corrales1.jpg" class="img-responsive" alt="nav_img"></a>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cc_ps_tabs">
                                <a class="button secondary url owl_nav" href="#one"><img src="images/shop/paneles-para-corrales.jpg" class="img-responsive" alt="nav_img"></a>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cc_ps_tabs">
                                <a class="button secondary url owl_nav" href="#two"><img src="images/shop/puerta-alta.jpg" class="img-responsive" alt="nav_img"></a>
                            </div>
                        ...
                        <div class="cc_ps_top_slider_section">
                            <div class="owl-carousel owl-theme">
                                <div class="item" data-hash="zero">
                                    ...
                                    <img class="small img-responsive" src="images/shop/corrales1.jpg" alt="small_img" />

                                </div>
                                <div class="item" data-hash="one">

                                    <img class="small img-responsive" src="images/shop/paneles-para-corrales.jpg" alt="small_img" />

                                </div>
                                <div class="item" data-hash="two">

                                    <img class="small img-responsive" src="images/shop/puerta-alta.jpg" alt="small_img" />
                                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="btc_shop_single_prod_right_section">
                        ...
                        <div class="btc_shop_sin_pro_icon_wrapper">
                            ...
                            <h5>Nuestros corrales están diseñados respetando todas las normas de bienestar animal que permite al animal alimentarse y descansar. El sistema de paneles y puertas permite realizar la configuración ideal de corrales que usted necesita para su campo. Son de alta calidad y resistentes. Disponibles en caños de 1.5” por 2mm. de espesor y en largo de 3 m. por 1.5 m. de altura.</h5>
                            <ul>
                                <li><i class="fa fa-long-arrow-right"></i> Paneles</li>
                                <li><i class="fa fa-long-arrow-right"></i> Puertas Altas</li>
                            </ul>
                        </div>
