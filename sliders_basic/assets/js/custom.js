...
//----------------------- BASIC SLIDER 5 MENU FIXED JS  -----------------------//
	
	$(window).scroll(function(){
		var window_top = $(window).scrollTop() + 1; 
		if (window_top > 50) {
			$('.section5_logo_wrapper').addClass('menu_fixed animated fadeInDown');
		} else {
			$('.section5_logo_wrapper').removeClass('menu_fixed animated fadeInDown');
		}
	});
