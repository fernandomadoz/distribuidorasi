...
<head>
    ...
    <title>Tenaza corta alambre</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-xs-12 col-sm-6">
                    <h1> Tenaza corta alambre </h1>
                </div>
                <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                    <div class="sub_title_section">
                        <ul class="sub_title">
                            <li> <a href="#"> Home </a> <i class="fa fa-angle-right" aria-hidden="true"></i> </li>
                            <li> Tenaza corta alambre </li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="video_img_section_wrapper">
						<div class="video_nav_img hidden-xs">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <a class="button secondary url owl_nav" href="#zero"><img src="images/shop/gripple-tenaza.jpg" class="img-responsive" alt="nav_img"></a>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cc_ps_tabs">
                                <a class="button secondary url owl_nav" href="#one"><img src="images/shop/gripple-tenaza1.jpg" class="img-responsive" alt="nav_img"></a>
                            </div>
                        ...
                        <div class="cc_ps_top_slider_section">
                            <div class="owl-carousel owl-theme">
                                <div class="item" data-hash="zero">
                                    ...
                                    <img class="small img-responsive" src="images/shop/gripple-tenaza.jpg" alt="small_img" />

                                </div>
                                <div class="item" data-hash="one">

                                    <img class="small img-responsive" src="images/shop/gripple-tenaza1.jpg" alt="small_img" />
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="btc_shop_single_prod_right_section">
                        ...
                        <div class="btc_shop_sin_pro_icon_wrapper">
                            ...
                            <h5> Cortador de alambre Gripple de hasta 4 mm de diámetro, ideal para cortar perfectamente el alambre sobrante.</h5>
                            <h5> Diseñado para uso con una sola mano.</h5>
                            <h5> Empuñaduras antideslizantes con cierre de seguridad.</h5>
                            <h5> Mordazas endurecidas para mayor durabilidad y un corte limpio.</h5>
                            <ul>
                            <h5>DATOS TECNICOS</h5>
                                <li><i class="fa fa-long-arrow-right"></i> Tenazas endurecidas y duraderas</li>
                                <li><i class="fa fa-long-arrow-right"></i> Conserva la estructura del cable</li>
