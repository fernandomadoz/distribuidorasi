...
<head>
    ...
    <title> Electrificadores de Alambrados </title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-xs-12 col-sm-6">
                    <h1> Electrificadores de Alambrados </h1>
                </div>
                <div class="col-lg-4 col-md-4 col-xs-12 col-sm-6">
                    <div class="sub_title_section">
                        <ul class="sub_title">
                            <li> <a href="#"> Home </a> <i class="fa fa-angle-right" aria-hidden="true"></i> </li>
                            <li> Electrificadores de Alambrados </li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="btc_shop_single_prod_right_section">
                        <h1>Electrificadores de Alambrado MAGNUM</h1>
                        <div class="btc_shop_sin_pro_icon_wrapper">
                            ...
                            <h5>La herramienta mas económica y práctica para el manejo de los recursos y el control de animales. En sus tres formatos: de 12 volts, 220 volts y dual (12 y 220 volts)</h5>
                            <ul>
                                <li><i class="fa fa-long-arrow-right"></i> PX - 12 Volts</li>
                                <li><i class="fa fa-long-arrow-right"></i> PY - 220 Volts.</li>
                                <li><i class="fa fa-long-arrow-right"></i> PXY - Dual 12/220 Volts.</li>
                                <li><i class="fa fa-long-arrow-right"></i> Desde 10 km. hasta 800 km. </li>
                                <li><i class="fa fa-long-arrow-right"></i> Garantía 2 años.</li>
                                <li><i class="fa fa-long-arrow-right"></i> Excelente servicio post–venta. </li>
                            </ul>
                        </div>
