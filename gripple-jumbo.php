                    ...
                    <div class="video_img_section_wrapper">
						<div class="video_nav_img hidden-xs">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <a class="button secondary url owl_nav" href="#zero"><img src="images/shop/gripple-jumbo.jpg" class="img-responsive" alt="nav_img"></a>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cc_ps_tabs">
                                <a class="button secondary url owl_nav" href="#one"><img src="images/shop/gripple-jumbo1.jpg" class="img-responsive" alt="nav_img"></a>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cc_ps_tabs">
                        ...
                        <div class="cc_ps_top_slider_section">
                            <div class="owl-carousel owl-theme">
                                <div class="item" data-hash="zero">
                                    ...
                                    <img class="small img-responsive" src="images/shop/gripple-jumbo.jpg" alt="small_img" />

                                </div>
                                <div class="item" data-hash="one">

                                    <img class="small img-responsive" src="images/shop/gripple-jumbo1.jpg" alt="small_img" />

                                </div>
                                <div class="item" data-hash="two">

                                    <iframe width="100%" height="500" src="https://www.youtube.com/embed/PKlYJxGq11A" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="btc_shop_single_prod_right_section">
                        ...
                        <div class="btc_shop_sin_pro_icon_wrapper">
                            ...
                            <h5> Gripples Jumbo es el más grande de la serie Gripple-Plus.</h5>
                            <h5> Los Gripples Jumbo cuentan con una impresionante capacidad de carga de trabajo de 600kg. y se ajustan a diámetros de alambre que van desde 2.5 - 3.15 mm.</h5>
                            <ul>
                            <h5>DATOS TECNICOS</h5>
                                <li><i class="fa fa-long-arrow-right"></i> Límite de capacidad de carga de 600 Kg.</li>
                                <li><i class="fa fa-long-arrow-right"></i> Límite de capacidad de carga de 600 Kg.</li>
