...
<head>
    ...
    <title> Medidores de Humedad </title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-xs-12 col-sm-6">
                    <h1> Medidores de Humedad para grano / forraje / madera </h1>
                </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="sidebar_widget">
                                    <div class="sc_shop_add sc_shop_fullwidth">
                                        <a href="#"><img src="images/shop/banner_medidores-humedad.jpg" class="img-responsive" alt="shop_img" /></a>
                                    </div>
                                </div>
                                <div class="sidebar_widget">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        ...
                                                        <img src="images/shop/wille55.jpg" alt="shop_img" class="img-responsive" />
                                                    ...
                                                    <div class="btc_shop_indx_img_cont_wrapper">
                                                        ...
                                                        <h1><a href="WILE 55.php">WILE 55</a></h1>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                <div class="btc_shop_indx_cont_box_wrapper">
                                                    <div class="btc_shop_indx_img_wrapper">
                                                        ...
                                                        <img src="images/shop/wille25.jpg" alt="shop_img" class="img-responsive" />
                                                        <div class="cc_li_img_overlay">
                                                            <div class="cc_li_img_text">
                                                                <ul>
                                                    ...
                                                    <div class="btc_shop_indx_img_cont_wrapper">
                                                        ...
                                                        <h1><a href="WILE 25.php">WILE 25</a></h1>
                                                        <div class="cc_li_cont_wrapper">
